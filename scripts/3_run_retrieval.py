...
from src.retrieval.interaction_matrix import process_retrieval_results_to_matrix
...
def main():
    ...
    # )
    # results_path = root_dir / "data" / "interaction_matrix"
    ...
    #     str(vectordb_path), str(results_path), model_name=MODEL
    # )
    ...
    process_retrieval_results_to_matrix(
        results_file="data/interaction_matrix/interaction_results.json",
        output_dir="data/interaction_matrix",
    )
    print("✅ Interaction matrix saved successfully!")
